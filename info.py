...
CUSTOM_FILE_CAPTION = environ.get('File Name : <a href="https://t.me/Tamil247Entertainments1">@Krishnar</a> ~ <code>{file_name}</code>   DM Here If Any Problem - @Contact_Tamil247_bot   LIKE ⚡️| SHARE 💯| SUBSCRIBE ❤️  Join Our Main Channel - @Tamil247Entertainments1  #FIRSTONTELEGRAM' )", None)
